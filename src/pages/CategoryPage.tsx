...
const categoryData: Record<string, {
  ...
  "get-started": {
    title: "Get started",
    articles: [
      { id: "1", title: "Creating Your First Account" },
      { id: "2", title: "Understanding the Dashboard Overview" },
      { id: "3", title: "Setting Up Your User Profile" },
      { id: "4", title: "Quick Start Guide for New Users" },
      { id: "5", title: "Navigating the Main Menu" },
      { id: "6", title: "Customizing Your Workspace" },
      { id: "7", title: "Inviting Team Members" },
      { id: "8", title: "Understanding User Roles and Permissions" },
      { id: "9", title: "Configuring Your First Project" },
      { id: "10", title: "Best Practices for Getting Started" },
      { id: "11", title: "Mobile App Installation Guide" },
      { id: "12", title: "Keyboard Shortcuts and Tips" },
      { id: "13", title: "Importing Data from Other Tools" },
      { id: "14", title: "Video Tutorial: Your First 15 Minutes" },
      { id: "15", title: "Common Mistakes to Avoid" },
    ],
  },
  "billing": {
    title: "Billing",
